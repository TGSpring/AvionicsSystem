...
#define MONGOC_USER_SET_CFLAGS " /nologo /DWIN32 /D_WINDOWS /utf-8 /MP "

#define MONGOC_USER_SET_LDFLAGS "/machine:x64"

/* MONGOC_CC is used to determine what C compiler was used to compile mongoc */
#define MONGOC_CC "C:/Program Files/Microsoft Visual Studio/2022/Community/VC/Tools/MSVC/14.36.32532/bin/Hostx64/x64/cl.exe"
